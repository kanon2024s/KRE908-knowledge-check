const quizData = [
    ...
    },
    {
      "FIELD1": 17,
      "type": "choice",
      "text": "2006年12月31日に8年半ぶりのアルバムだからどうした！をリリースした<br />BY PHAR THE DOPEST。<br />収録されているトラックは全てあるルールに則ってサンプリングで作成されている。<br />そのルールとはなにか",
    ...
    },
    {
      "FIELD1": 26,
      "type": "text",
      "text": "CONCERT TOUR '07「K-ing」@横浜ブリッツにてライブが終わり楽屋に戻ろうとしたところ客席にから舞台にあるものが投げ入れられました。<br />それは何でしょう",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 48,
      "type": "text",
      "text": "以下はどの曲のリリックか。<br />「映画に飲み込まれたよう崩れて消えた時の壁はもう繰り返すばかりなのになぜだろう追いつけない諦めちゃダメだよ」",
      "fields": "答え",
