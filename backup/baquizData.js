const quizData = [
    ...
    },
    {
      "FIELD1": 12,
      "type": "choice",
      "text": "2008年自身のブログにて\n社長からジブリ作品のTシャツを貰った嬉しすぎると綴っていました。\n前から〇〇のTシャツがあれば絶対着ると言っていたそうです。何のTシャツでしょうか",
    ...
    },
    {
      "FIELD1": 13,
      "type": "choice",
      "text": "2024年にKREVAがある時計ブランドの広告モデルとして採用された\nそのブランドとはなにか?",
    ...
    },
    {
      "FIELD1": 14,
      "type": "choice",
      "text": "2022年クリスマスイブの日KREVA宅に週刊文春が押しかけた\nその際の取材内容とはなにか?",
    ...
    },
    {
      "FIELD1": 15,
      "type": "choice",
      "text": "授業型エンターテイメントとして行われたKREVA classで\nKREVAの助手を勤めたキャラクターの名前は?",
    ...
    },
    {
      "FIELD1": 16,
      "type": "choice",
      "text": "Ravijour(ラヴィジュール)というブランドの為に書き下ろされた楽曲としてSo Sexyがある。\nではRavijourどのような商品を取り扱っていたブランドか",
    ...
    },
    {
      "FIELD1": 17,
      "type": "choice",
      "text": "2006年12月31日に8年半ぶりのアルバム\nだからどうした！をリリースしたBY PHAR THE DOPEST\n収録されているトラックは全てあるルールに則ってサンプリングで作成されている\nそのルールとはなにか",
    ...
    },
    {
      "FIELD1": 18,
      "type": "choice",
      "text": "ある日、KREVAの娘が葉加瀬太郎の情熱大陸に歌詞を付けました。\nその歌詞とは次のうちどれか",
    ...
    },
    {
      "FIELD1": 19,
      "type": "choice",
      "text": "紅白歌合戦にKICK THE CAN CREWが出場した時\n楽屋でlittleとKREVAは何をしていた?",
    ...
    },
    {
      "FIELD1": 26,
      "type": "text",
      "text": "KREVA CONCERT TOUR '07 『K-ing』@横浜ブリッツにて\nライブが終わり楽屋に戻ろうとしたところ客席にから舞台にあるものが投げ入れられました\nそれは何でしょう",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 29,
      "type": "text-multi-field",
      "text": "2021年に出演した日テレのmusic blood にてKREVAがある人の曲をカバーした。誰のなんという曲か",
    ...
    },
    {
      "FIELD1": 30,
      "type": "text",
      "text": "勝手にremixシリーズとしてPerfumeのある楽曲をKREVAがremixした事がある\nその曲とは何か",
      "fields": "答え",
      "correctAnswer": "575"
    },
    {
    ...
    },
    {
      "FIELD1": 34,
      "type": "text",
      "text": "勝手にREMIXシリーズでは様々なアーティストの曲が勝手にREMIXされてきた。\nその中で実際にリリースまでされている曲のアーティストは三浦大知と誰?",
      "fields": "アーティスト名",
    ...
    },
    {
      "FIELD1": 36,
      "type": "text",
      "text": "KREVAの楽曲「挑め」ではあるテーマに沿ってリリックが書かれている。\nそのテーマとは決して〇と言わないことである。〇に入るのは何か?",
      "fields": "答え",
      "correctAnswer": "3"
    },
    {
    ...
    },
    {
      "FIELD1": 38,
      "type": "text",
      "text": "2012年KREVAがTwitterにてラッパーを募って出来た曲はPROPSですが、\nTwitterでKREVAが元々候補の1人として考えていたラッパーの名前を出したところ\nそのラッパーは1対1でオファー掛けれるように頑張りますと断りをいれる。\nそのラッパーとは誰か",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 39,
      "type": "text",
      "text": "2016年KREVAが所属していた事務所による\nstudio tribute albumとしてリリースされたアルバム名は何か",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 40,
      "type": "text",
      "text": "KREVAのシングルCDにカップリングとして収録されている曲で\n自身の楽曲ではなく、他のアーティストの曲をカバーした3曲ある\n今夜はブギーバック、君に、胸キュン。-浮気なヴァカンス-あともう一曲はなに?",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 41,
      "type": "text",
      "text": "アルバムProjectKでは客演が0人であるがその他にもう1枚客演が0人のアルバムがある。\nそれはどのアルバムか\n(なおベスト盤や、録りなおし、ミニアルバムは含まない)",
      "fields": "答え",
      "correctAnswer": "SPACE"
    },
    {
    ...
    },
    {
      "FIELD1": 43,
      "type": "text",
      "text": "2007年音楽雑誌BridgeにてKREVAが吉井和哉と対談した際に吉井和哉にここだけは負けないというポイントを語っていた\nそれは何か",
      "fields": "答え",
      "correctAnswer": "デコメール"
    },
    {
      "FIELD1": 44,
      "type": "text",
      "text": "2007年音楽雑誌BridgeにてKREVAが吉井和哉と対談した際に\n自分の曲を相手にカバーしてもらうとしたらどの曲?という問いかけに対しKREVAはどの曲を選択したでしょう",
      "fields": "答え",
      "correctAnswer": "スタート"
    },
    {
      "FIELD1": 45,
      "type": "text",
      "text": "2003.12.30名古屋のクラブに遊びに来ていたKREVA\nオープンマイクの時間にラッパー達に煽られたのでステージに上がり\nフリースタイルでラップをし、最後には以下のパンチラインと共にマイクを叩きつけステージを後にした\n〇〇の部分に入るリリックはなにか\nこんなにいんだろラッパーはいっぱいだけど一つだけ言いてぇこと俺が日本で1番ラップで〇〇男",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 46,
      "type": "text",
      "text": "2011年に幻冬舎から刊行されたKREVAの初著書といえばKREAM(クリーム)\nですがそれに続くタイトルとはなんでしょう",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 50,
      "type": "text",
      "text": "渋谷のクラブshibuya NUTSが監修したコンピレーションアルバムthis is...にFAKEASSという曲でKREVAが参加している\nその曲ではアーティスト名がTR-908となっている\nこのTR-908とはKREVAと誰が組んでいるユニット名でしょう",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 51,
      "type": "text",
      "text": "2023年に行われた「KREVA CONCERT TOUR 2023『NO REASON』」にて\nICEの国岡真由美がゲストで登場しMellow Blueという曲を披露した\nさてその次にKREVAが歌った曲とはなんでしょうか?",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 52,
      "type": "text",
      "text": "47都道府県RAPにて以下のリリックは何県と韻を踏む為のフリでしょう\n進み続けることに意味がある気付けば到着",
      "fields": "答え",
      "correctAnswer": "新潟"
    },
    {
      "FIELD1": 53,
      "type": "text-multi-field",
      "text": "KREVAの楽曲PROPSにはCDとDVDがある。\nそれぞれどの楽曲のシングルCDの先着予約特典として配られたものか",
    ...
    },
    {
      "FIELD1": 55,
      "type": "text",
      "text": "久保田利伸meets KREVAとしてリリースした楽曲M☆A☆G☆I☆Cはサンプリング手法でビートが作成されている\nKREVAのソロ曲でも元ネタが同じ曲が存在している。それは何という曲か?",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 57,
      "type": "text",
      "text": "KREVAのアルバムよろしくお願いします\nの中でDJ TATSUTAがプロデュースしている曲はどれでしょう",
      "fields": "答え",
    ...
    },
    {
      "FIELD1": 59,
      "type": "text-multi-field",
      "text": "KREVAの曲knockでは最後の歌部分にAIにが使われている\nKREVAの歌声をAIよって別人の声に変えて重ねるという手法が取られている\n何人分を重ねているでしょう",
      "correctAnswer": "9",
      "fields": "人"
    },
    {
    ...
    },
    {
      "FIELD1": 64,
      "type": "choice",
      "text": "アルバム元新人KREVAは新人KREVAより一曲少ない。カットされた曲は何か?",
    ...
    },
    {
      "FIELD1": 65,
      "type": "text",
      "text": "アルバム愛自分博~紫~に付属してるDVDにはイッサイガッサイのPVが別Verとして収録されている。それは何か?",
      "correctAnswer": "夏",
      "fields": "ver"
    },
    {
      "FIELD1": 66,
      "type": "choice",
      "text": "アルバム何卒よろしくお願いしますはよろしくお願いしますより一曲少ない。カットされた曲は何か?",
    ...
    },
    {
      "FIELD1": 67,
      "type": "choice",
      "text": "アルバム嘘と煩悩の煩悩版に収録されているFM908で自分の歌詞が焼き芋だとしたら居場所の歌詞は〇〇ですねと言った。〇〇に入るのは何?",
